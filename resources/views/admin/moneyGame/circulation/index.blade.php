...
@section('title')
    Thống kê tiền luân chuyển trong game
@endsection
@section('content')
                ...
                <div class="widget-box">
                    ...
                    <div class="widget-body">
                        <div class="widget-main">
                            {!! Form::open(['method'=>'GET','url'=>'moneyGame/circulation','role'=>'search'])  !!}
                            <div class="row">
    ...
    <script type="text/javascript">
        $(function () {
            ...
            var total6 = new Array();

            <?php foreach($moneyArr as $day => $value):?>
                array_date.push(['<?php echo $day;  ?>']);
                total6.push(<?php echo isset($value[6]) ?  $value[6] : 0 ?>);
            <?php endforeach ?>
