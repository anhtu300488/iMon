...
class QuickTipController  extends Controller
{
    public function index(Request $request){
        ...
        return view('admin.others.tip.index',compact('data', 'partner'))->with('i', ($request->input('page', 1) - 1) * $perPage);
    }
    ...
    public function create(){
        ...
        return view('admin.others.tip.create',compact('partner'));
    }
    ...
    public function edit($id){
        ...
        return view('admin.others.tip.edit',compact('tip', 'partner'));
    }
