...
class XiToController extends Controller
{
    public function index(Request $request){
        ...
        $query = MatchLog::query()->where("gameId", "=", 2);
        if($roomId != ''){
...
//        $data  = $query->offset(0)->limit(300)->get();
        ...
        return view('admin.game.xito.index',compact('data', 'typeArr'))->with('i', ($request->input('page', 1) - 1) * $perPage);
    }
}
