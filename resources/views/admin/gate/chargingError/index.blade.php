                ...
                <div class="widget-box">
                    ...
                    <div class="widget-body">
                        <div class="widget-main">
                            {!! Form::open(['method'=>'GET','url'=>'gate/chargingError','role'=>'search', 'name' => 'formSearch'])  !!}
                    ...
                    <table id="simple-table" class="table table-striped table-bordered table-hover">
                        ...
                        @foreach($data as $key => $rs)
                            <tr @if($rs->status === 5) style="background-color:#3a87ad; color: white" @endif >
                                ...
                                <td>@if($rs->useChargingGateway == 1)  <span class="label label-sm label-success">V</span> @elseif($rs->status == 3) <span class="label label-sm label-inverse arrowed-in">X</span> @else <span class="label label-sm label-inverse arrowed-in">Deactive</span> @endif</td>
